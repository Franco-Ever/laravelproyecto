            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item list-group-item-success"><strong>Precio:</strong> {{$dato->precio}} {{$dato->valor}}</li>
                        <li class="list-group-item list-group-item-success"><strong>Categoria:</strong> {{$dato->categoria}}</li>
                        <li class="list-group-item list-group-item-success"><strong>Cantidad y peso:</strong> {{$dato->cantidad}} {{$dato->peso}}</li>
                    </ul>
                    <br><br>
